...
//  CUMBLogic->SetVisAttributes(G4VisAttributes::Invisible);
 ...
 new G4PVPlacement(0,G4ThreeVector(0,0,(l_CUMC/2 + 27.8*mm + 67*mm - l_TRGT/2.)),CUMCLogic,"CUIC",fMyLogic,false,1);
...
//  KAPDLogic->SetVisAttributes(G4VisAttributes::Invisible);
 ...
 G4LogicalVolume* BTRGTLogic=new G4LogicalVolume(BTRGT,fMaterial,"BTRGT");
// G4cout << "Eat This Bastard: " << ((G4Material*)BTRGTLogic->GetMaterial())->GetName() << G4endl;
